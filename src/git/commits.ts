...
// The detector lives in `autostash.ts`, shared with the pull; re-exported so
// the rebase integration test asserts against the same function this uses.
export { autostashConflicted } from './autostash';
...
export async function rebaseOnto(
  ...
  return autostashConflictedIn(output) ? 'autostash-conflicted' : 'rebased';
}
